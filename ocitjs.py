...
cl = LineClient("EMAILMU","PASSWORD EMAIL") #SELFBOT
cl.log("Auth Token : " + str(cl.authToken))

ki = LineClient("EMAILMU","PASSWORD EMAIL") #asis1
ki.log("Auth Token : " + str(ki.authToken))

kk = LineClient("EMAILMU","PASSWORD EMAIL") #asis2
kk.log("Auth Token : " + str(kk.authToken))

kc = LineClient("EMAILMU","PASSWORD EMAIL") #asis3

kb = LineClient("EMAILMU","PASSWORD EMAIL") #asis4
kb.log("Auth Token : " + str(kc.authToken))

sw = LineClient("EMAILMU","PASSWORD EMAIL") #ajs

print("\n﹦﹦﹦﹦﹦﹦﹦﹦sats bots﹦﹦﹦﹦﹦﹦﹦﹦\n")

poll = LinePoll(cl)
call = cl
creator = ["u65459443fbfc754ca54d2de033d302bf"]
owner = ["u65459443fbfc754ca54d2de033d302bf"]
admin = ["u65459443fbfc754ca54d2de033d302bf"]
staff = ["u65459443fbfc754ca54d2de033d302bf","uf0ed47843782b3b7225b7fd85c609a58"]
...
wait = {
    ...
    "unsend":False,
    "mention":"O ow kamu ketauaan, mengintip lagiii",
    "Respontag":"Fix yang tag aku sayang",
    "welcome":"sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ\nJangan Baper yaa\nsSemoga langgeng 😚🙏",
    "leave":"sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ\nTiati di jalan, kalo kangen balik lagi",
    "comment":"Aku udh like, jangan minta lagi yaa",
    "message":"Makasih udah add akuu,, kalo ada perlu bilang aja",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def leaveMembers(to, mid):
    try:
        arrData = ""
        textx = "┏━━ • ʟᴇᴀᴠᴇ • ━━┓\nNgambek nih kayanya ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
    ...
    try:
                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sw.sendMessage(op.param1,"Buka QR izin dulu woy!!")
            ...
            if wait["autoAdd"] == True:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    if (wait["message"] in [" "," ","\n",None]):
                        ...
                        cl.sendContact(op.param1, "u65459443fbfc754ca54d2de033d302bf")
        ...
        if op.type == 19:
            if op.param3 in admin:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    wait["blacklist"][op.param2] = True
                    random.choice(ABC).findAndAddContactsByMid("u65459443fbfc754ca54d2de033d302bf")
                    random.choice(ABC).inviteIntoGroup(op.param1,["u65459443fbfc754ca54d2de033d302bf"])
                    random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                else:
                	pass
        ...
        if op.type == 19:
            if op.param3 in staff:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    wait["blacklist"][op.param2] = True
                    random.choice(ABC).findAndAddContactsByMid("uaf3c5cc916488f046144f512c7fd770e")
                    random.choice(ABC).inviteIntoGroup(op.param1,["uaf3c5cc916488f046144f512c7fd770e"])
                    random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                else:
                	pass
            ...
            if op.param1 in ghost:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        sw.kickoutFromGroup(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                        sw.sendMessage(op.param1,"Enak aja lu sembarangan kik orang!!")
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    try:
                        if op.param3 not in wait["blacklist"]:
                            ...
                            ki.sendMessage(op.param1,"jangan maen cancel aja woyy!!")
                        ...
                        try:
                            if op.param3 not in wait["blacklist"]:
                                ...
                                kk.sendMessage(op.param1,"jangan maen cancel aja woyy!!")
                            ...
                            try:
                                if op.param3 not in wait["blacklist"]:
                                    ...
                                    kc.sendMessage(op.param1,"jangan maen cancel aja woyy!!")
                                ...
                                try:
                                    if op.param3 not in wait["blacklist"]:
                                        ...
                                        kb.sendMessage(op.param1,"jangan maen cancel aja woyy!!")
            ...
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        cl.acceptGroupInvitation(op.param1)
                        ck.acceptGroupInvitation(op.param1)
                        cb.acceptGroupInvitation(op.param1)
                        ki.cancelGroupInvitation(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                    except:
                        try:
                            ...
                            try:
                                ...
                                try:
                                    kb.kickoutFromGroup(op.param1,[op.param2])
                                    kb.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid])
                                    cl.acceptGroupInvitation(op.param1)
                                    ki.acceptGroupInvitation(op.param1)
                                    kk.acceptGroupInvitation(op.param1)
                                    kc.acceptGroupInvitation(op.param1)
                        ...
                        if cmd == "self on":
                         ...
                         if wait["selfbot"] == True:
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"🅂🄰🅃🅂") 
                                ma = "u65459443fbfc754ca54d2de033d302bf"
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)                              
                                cl.cancelGroupInvitation(msg.to, [Amid,Bmid,Cmid,Dmid,Zmid])
...
#===========Hiburan============#
                        ...
                        elif "!ytubedl" in msg.text.lower():
                          if wait["ytube"] == True:
                                try:
                                    proses = cmd.split(" ")
                                    urutan = cmd.replace(proses[0] + " ","")
                                    r = requests.get("https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q={}&type=video&key=AIzaSyC_D5-ehj2VWozB8qc9pyAqb4bT_6GeLH8".format(urutan))
                                    data = r.json()
                                    ais = data["items"][0]
                                    video = pafy.new(ais['id']['videoId'])
                                    fitri = "[ SATS ]\n Sabar Lagi Prosess..."
                                    cl.sendReplyMessage(msg.id, to, fitri)
